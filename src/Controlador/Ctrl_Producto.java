...
public class Ctrl_Producto {
    ...
    public boolean guardar(Producto objeto) {
        ...
        try {
            ...
            consulta.setString(6, objeto.getCodigo());
    ...
    public boolean actualizar(Producto objeto, int idProducto) {
        ...
        try {
            ...
            PreparedStatement consulta = cn.prepareStatement("update productos set nombre=?, cantidad = ?, precio = ?, descripcion= ?, codigo = ?, idCategoria = ?, estado = ? where idProducto ='" + idProducto + "'");
     ...
     */
     ...
     public boolean actualizarStock(Producto object, int idProducto) {
        ...
        Connection cn = Conexion.conectar();
        try {
            PreparedStatement consulta = cn.prepareStatement("update productos set stock=? where idProducto ='" + idProducto + "'");
